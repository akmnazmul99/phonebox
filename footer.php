            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-4">
                    ...
                    <aside>
                        ...
                        <address>
                            ...
                            <abbr title="Email">Email:</abbr> <a href="contact_us.php">ask@fonebox.com.sg</a>
                ...
                <div class="col-md-3 col-sm-4">
                    ...
                    <aside>
                        ...
                        <header><h4>About FoneBox</h4></header>

                        <p style="text-align: justify;">

                        FoneBox USA Pte. Ltd. is an international voice wholesale 
			and a-z termination company has taken a new entrance in the 
			ever blossoming telecom sector of Singapore. FoneBox is a prominent
			telecommunications company aiming to deliver an array of reasonable...</p>

                        <div>

                            <a href="about_us.php" class="read-more">Details</a>
    ...
    <section id="footer-bottom">
        ...
        <div class="container">
            ...
            <div class="footer-inner">
                ...
                <div class="copyright">© FoneBox USA Pte. Ltd. 2015. All rights reserved.</div><!-- /.copyright -->
